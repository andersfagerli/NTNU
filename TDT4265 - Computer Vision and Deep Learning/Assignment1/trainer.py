...
class BaseTrainer:
    ...
    def train(
        ...
        for epoch in range(num_epochs):
            ...
            for X_batch, Y_batch, batch_indice in iter(train_loader):
                ...
                if global_step % num_steps_per_val == 0:
                    ...
                    # Check which batch indice that gives large validation loss
                    # if val_loss > 2*prev_val:
                        # print("[",batch_indice[0],",", batch_indice[-1],"]")
                    # prev_val = val_loss
