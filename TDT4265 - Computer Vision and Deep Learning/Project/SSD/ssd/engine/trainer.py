...
def do_train(cfg, model,
    ...
    max_time = 43200 # Stop training after 12 hours
    ...
    for iteration, (images, targets, _) in enumerate(data_loader, start_iter):
        ...
        if iteration >= cfg.SOLVER.MAX_ITER:
            break
        if start_training_time - end > max_time:
            print("Maximum time exceeded at training time: ", str(datetime.timedelta(seconds=start_training_time - end)))
